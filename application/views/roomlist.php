                                    ...
                                    <div class="d-md-flex justify-content-between">
                                        <div class="item-overview">
                                            ...
                                            <div class="room-content d-flex align-items-center mb-3">
                                             <div class="room-size fs-16 font-weight-bold mr-2">
    <?php echo html_escape($singleroom->roomsize ?? ''); ?>
    &nbsp;
    <span>
        <?php echo html_escape($roommeasure->roommesurementitle ?? ''); ?>
    </span>
</div>

<?php foreach ($facilityinfo as $list) { ?>
    <div class="room-bed-config mr-2"
         data-toggle="tooltip"
         data-placement="top"
         title="<?php echo html_escape($list->facilitytitle); ?>">
        <img src="<?php echo base_url() . html_escape(!empty($list->image) ? $list->image : 'assets/img/Home-page/save_line_all.png'); ?>"
             alt=""
             class="img-fluid">
    </div>
<?php } ?>
