...
.room-list {
    ...
    overflow: hidden; /* fallback containment */
        ...
        /* Mobile slider images - object-fit cover */
@media (max-width: 768px) {
    .header-slider .slide-img img {
        width: 100% !important;
...
@media (max-width: 991.98px) {
    .header-slider .slide-img img {
        width: 100% !important;   /* always fill the container width */
        height: auto !important;  /* maintain aspect ratio */
        object-fit: contain !important; /* fit the whole image inside */
    }

    /* Make the slider container auto height so image fits */
    .header-slider,
    .header-slider .owl-item {
        height: auto !important;
    }
...
<img src="<?php echo base_url() . html_escape($webinfo->logo ?? 'assets/img/header-logo.png'); ?>"
     alt=""
     style="height: 8vh">
        </a>
        <div class="d-flex order-lg-last">
            <ul class="navbar-right d-flex align-items-center list-unstyled mb-0">
                ...
                <li class="nav-item nav-btn">
                    ...
                    <div class="row no-gutters custom-search-input-2 search-form-content mt-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-3 mb-lg-0">
                            ...
                            <ul class="list-unstyled social-icon">
                                <li><a href="<?php echo html_escape($link->link1) ?>" target="_blank" rel="noopener noreferrer"> 
                                    <i class="fab fa-instagram icon-wrap"></i> <span><?php echo  display("instagram") ?> </span> </a></li>
                                <li><a href="<?php echo html_escape($link1->link1) ?>" target="_blank" rel="noopener noreferrer"> 
                                    <i class="fab fa-twitter icon-wrap"></i> <span><?php echo  display("twitter") ?></span> </a></li>
                                <li><a href="<?php echo html_escape($link2->link1) ?>" target="_blank" rel="noopener noreferrer"> 
                                      <i class="fab fa-linkedin-in icon-wrap"></i> <span><?php echo  display("linkedin") ?></span> </a></li>
                                <li><a href="<?php echo html_escape($link3->link1) ?>" target="_blank" rel="noopener noreferrer" class="tiktok-icon"> 
                                   <span class="icon-wrap">
    <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"
         xmlns="http://www.w3.org/2000/svg">
        <path d="M12.004 2c1.043 0 1.948.768 2.072 1.801.267 2.287 1.785 3.993 4.02 4.356v2.058c-1.488 0-2.901-.474-4.092-1.338v6.41c0 3.09-2.507 5.593-5.6 5.593-3.09 0-5.6-2.503-5.6-5.593 0-3.09 2.51-5.592 5.6-5.592.373 0 .737.038 1.087.111v2.254a3.34 3.34 0 0 0-1.087-.18c-1.846 0-3.344 1.493-3.344 3.33 0 1.84 1.498 3.332 3.344 3.332 1.847 0 3.346-1.492 3.346-3.332V2z"/>
    </svg>
</span>
