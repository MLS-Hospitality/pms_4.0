...
| -------------------------------------------------------------------
*/
$config['log_threshold'] = 0;          // ← Set to 0 to disable logging completely (best quick fix for now)
                                       // Alternatives: 1 = Error, 2 = Debug, 3 = Info, 4 = All

$config['log_path'] = '';              // ← Empty string = use default (application/logs/)
                                       // OR full path example: 'C:/xampp/htdocs/Test_hotel/application/logs/'

// Optional but recommended (prevents path issues):
...
$config['auto_cancel_secret_key'] = 'fKk687!fKk687!';
