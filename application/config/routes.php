...
$route['payment/initiate']='hotel/initiate_payment';
$route['payment/account/data']='hotel/get_account_data';
...
$route['reports/payment-report'] = "reports/report/payment_report";
$route['reports/payment-today'] = "reports/report/payment_today";
...
$route['room_reservation/booking-pending'] = "room_reservation/room_reservation/pending";
...
$route['room_reservation/delete/booking/(:num)']= "room_reservation/room_reservation/deletebooking/$1";
...
$route['setting/slider'] ='dashboard/Setting/room_slider';
$route['setting/room/slider/(:num)']        = 'dashboard/Setting/view_slider/$1';       // View all sliders for a room
$route['setting/room_slider/save_slider']   = 'dashboard/Setting/save_slider';         // Add new slider (AJAX)
$route['setting/room_slider/edit_slider/(:num)'] = 'dashboard/Setting/edit_slider/$1'; // Edit slider (AJAX)
$route['setting/room_slider/update_slider'] = 'dashboard/Setting/update_slider';       // Update slider (AJAX POST)
$route['setting/room_slider/delete_slider/(:num)'] = 'dashboard/Setting/delete_room_slider/$1'; // Delete slider (AJAX)
$route['404_override'] = '';
$route['translate_uri_dashes'] = FALSE;
...
foreach ($modules as $module) {
    ...
    // Correctly check if the module is a directory
    if (is_dir($modules_path . '/' . $module)) {
        $routes_path = $modules_path . '/' . $module . '/config/routes.php';

        // Check if the routes file exists and include it
