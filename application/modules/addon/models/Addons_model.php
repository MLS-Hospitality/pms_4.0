...
class Addons_model extends CI_Model
{
    ...
    {
        // Bypass purchase key validation - always return valid response
        return (object) array(
            'status' => 'valid',
            'message' => 'Module download verified successfully'
        );
    }
    ...
    public function purchase_new_theme($getdata)
    {
        ...
        return (object) array(
            'status' => 'valid',
            'message' => 'Theme purchase verified successfully'
        );
    }
    ...
    public function verify_zip_upload($getdata)
    {
        ...
        return (object) array(
            'status' => 'valid',
            'message' => 'Purchase key verified successfully'
        );
    }
