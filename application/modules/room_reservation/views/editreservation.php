        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <?php 
                    // Discount amount already calculated above (line ~154)
                    // Reuse the same variable to avoid duplicate calculation
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"
                                id="total_charge"><?php echo number_format($totalamount, 2); ?></label>
                        </div>
                    </div>
                </div>
            </div>
