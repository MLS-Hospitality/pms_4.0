...
.modal select:not(.select2-nationality) {
...
/* SPACE FOR ICON (SELECT2) */
.select2-nationality + .select2-container 
...
/* Remove Select2 arrow */
.select2-container--default .select2-selection--single .select2-selection__arrow {
    display: none !important;
}

/* Scope padding only to this select */
.select2-nationality + .select2-container 
.select2-selection--single {
    padding-left: 35px !important;
}
.select2-nationality::-ms-expand {
    display: none;
}
.select2-nationality,
#country,
                ...
                <table class="table table-bordered white-space-nowrap mb-0 room-list">
                    <tbody>
                                ...
                                <table class="table table-borderless mb-0 order-list">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="border-0">
                                                <div class="form-group mb-0">
                                                    <label class="font-weight-600 mb-1"><?php echo display("rent") ?></label>
                                                    <div class="icon-addon addon-md">
                        ...
                        <tr>
                            ...
                            <td class="text-center res-v-allign">
                                <button type="button" disabled class="btn btn-primary btn-sm newroom0" onclick="room(0)" id="newroom">
                                    <i class="fas fa-plus"></i>
                                </button>
                            </td>
                        </tr>
            ...
            <div class="card flex-fill w-100">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3" id="discount_row" style="display: none;">
                            <div class="form-group mb-0">
                                <label class="font-weight-600 mb-0"><?php echo "Discount" ?></label>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3" id="discount_amount_row" style="display: none;">
                            <div class="form-group mb-0">
                                <label class="font-weight-600 mb-0" id="discount_charge" style="color: #28a745;"><?php echo "0" ?></label>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div class="form-group mb-0">
                            ...
                            <div class="form-group mb-0">
                                ...
                                <div class="icon-addon addon-md">
                                    ...
                                    <input type="number" disabled class="form-control" id="advanceamount"
                                        placeholder="<?php echo display("advance_amount") ?>" min=0>
                                    <i class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card flex-fill w-100 border mb-4">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <div class="form-group mb-0">
                                                <label for ="code"><?php echo display("country_code") ?></label>
                                                <div class="icon-addon addon-md">
                                                    <i class="fas fa-phone input-icon"></i>
                                                    <select name="country_code" id="code" class="form-control select2-nationality">
                                                        <option value=""> <i class="fas fa-phone"></i><?php echo display('select_code'); ?></option>
                                                        <?php if(!empty($nations)){ ?>
                                                            <?php foreach($nations as $nation){ ?>
                                                                <option value="<?php echo html_escape($nation['phone_code']); ?>">
                                                                    <?php echo html_escape($nation['phone_code']) . ' — ' . $nation['name']; ?>
                                                                </option>
                                                            <?php } ?>
                                                        <?php } ?>
                                                    </select>
    ...
    <div class="form-group mb-0">
        <div class="icon-addon">
            ...
            <select name="nationality" id="nationality" 
                ...
                <option value=""><?php echo display('select_nationality'); ?></option>
                <?php foreach($nations as $nation){ ?>
                    <option value="<?php echo html_escape($nation['name']); ?>">
                        <?php echo html_escape($nation['name']); ?>
                    </option>
                <?php } ?>
            </select>
        </div>
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="form-floating with-icon mb-3">
                        <input type="text" class="form-control" id="existname"
                            placeholder="<?php echo display("customer_name") ?>" value="">
                        <label><?php echo display("customer_name") ?></label>
...
<input type="hidden" id="alluser">
<input type="hidden" id="allmobile">
<input type="hidden" id="allemail">
<input type="hidden" id="allpitype">
<input type="hidden" id="alluserid">
<input type="hidden" id="alllastname">
<input type="hidden" id="allgender">
<input type="hidden" id="allfather">
<input type="hidden" id="allpid">
<input type="hidden" id="alloccupation">
<input type="hidden" id="alldob">
<input type="hidden" id="allanniversary">
<input type="hidden" id="allimgfront">
<input type="hidden" id="allnationality">
<input type="hidden" id="allvip">
<input type="hidden" id="allcomments">
<input type="hidden" id="allimgback">
<input type="hidden" id="allimgguest">
<input type="hidden" id="allcontacttype">
<input type="hidden" id="allstate">
<input type="hidden" id="allcity">
<input type="hidden" id="allzipcode">
<input type="hidden" id="alladdress">
<input type="hidden" id="allcountry">
...
$(document).ready(function () {
    $('#exampleModal').on('shown.bs.modal', function () {
        // Initialize only selects that are not initialized yet
        $('#exampleModal select.select2-nationality').each(function() {
        ...
        $('#exampleModal select:not(.select2-nationality)').on('click mousedown touchstart', function(e) {
            e.stopPropagation();
            e.stopImmediatePropagation();
        });
    });

    // Optional: only destroy static selects if needed
    $('#exampleModal').on('hidden.bs.modal', function () {
        $('#exampleModal select.select2-nationality.static-select').select2('destroy');
    });
});
</script>
