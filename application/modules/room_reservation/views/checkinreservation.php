...
<div id="reservation">
    ...
    <div class="card mb-4">
        ...
        if($tax_Percent>0){
            $tax_Percent = ($total_amount*$tax_Percent)/100;
        }
        $taxPercent= $tax_Percent*$totaldays;
        if($setting->servicecharge>0){
            $s_charge = ($total_amount*$setting->servicecharge)/100;
        }
        $scharge = $s_charge*$totaldays;
        $bcharge = $totalamount;

        
        // Calculate subtotal (rent + tax + service charge)
        $subtotal = $totalamount+$taxPercent+$scharge;
        // Get discount amount from booking
        $discount_amount = !empty($bookingdata->discountamount) ? floatval($bookingdata->discountamount) : 0;
        // Calculate total amount per day after discount
        ...
        // Calculate paid and due amounts for check-in
        $total_bill = $totalamount;
        $paid_amount = !empty($bookingdata->paid_amount) ? floatval($bookingdata->paid_amount) : 0;
        $due_amount = max(0, $total_bill - $paid_amount);
        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <?php
                    $discount_amount = !empty($bookingdata->discountamount) ? $bookingdata->discountamount : 0;
                    $discount_display_style = $discount_amount > 0 ? '' : 'style="display: none;"';
                    ?>
                    <div class="col-md-6 mb-3" id="discount_row" <?php echo $discount_display_style; ?>>
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0"><?php echo "Discount" ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3" id="discount_amount_row" <?php echo $discount_display_style; ?>>
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="discount_charge" style="color: #28a745;">-<?php echo number_format($discount_amount, 2); ?></label>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-0" id="total_charge"><?php echo number_format($totalamount, 2); ?></label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="card flex-fill w-100">
            ...
            <div class="card-body">
                <div class="row">
                        ...
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                ...
                                <input type="text" disabled class="form-control" id="totalamount"
                                    value="<?php echo number_format($totalamount, 2); ?>" placeholder="Total amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            ...
                            <div class="icon-addon addon-md">
                                <i
                                    class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="text" disabled class="form-control" id="paidamount"
                                    value="<?php echo number_format($paid_amount, 2); ?>" placeholder="Paid amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-1 text-danger"><strong><?php echo display('due_amount') ?></strong></label>
                            <div class="icon-addon addon-md">
                                <i
                                    class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="text" disabled class="form-control font-weight-bold text-danger" id="dueamount"
                                    value="<?php echo number_format($due_amount, 2); ?>" placeholder="Due amount">
                                <i
                                    class=""><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></i>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group mb-0">
                            <label class="font-weight-600 mb-1"><?php echo display('advance_amount') ?> <small class="text-muted">(<?php echo 'Payment to make' ?>)</small></label>
                            <div class="icon-addon addon-md">
                                <i
                                    class=""><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?></i>
                                <input type="number" step="0.01" class="form-control" id="advanceamount"
                                    value="<?php echo number_format($due_amount, 2, '.', ''); ?>"
...
<div class="text-right mt-3">
    <button type="button" class="btn btn-secondary w-100p" onclick="checkinBooking()"
        id="bookingsave" disabled><?php echo display('checkin') ?></button>
</div>
...
<input type="text" id="currtime" value="<?php echo date("Y-m-d H:i"); ?>">
<?php
    $taxPercent = 0;
    if(!empty($taxsetting)){
        foreach($taxsetting as $tax){
...
<input type="hidden" id="totaldays" value="<?php echo $totaldays; ?>">
