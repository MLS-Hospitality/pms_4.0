                            ...
                            <table class="table table-bordered table-sm mb-0 tr-background">
                                <thead>
                                    <tr>
                                        ...
                                        <th><?php echo display("rent")." ".display("discount"); ?>
                                        </th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo html_escape($bookingdata[$l]->disrate.'%'); ?></td>
                                        ...
                                        // Step 4: Calculate service charge on BASE RENT (before discount) - will be calculated at total level

                                        // Step 5: Total = (base rent - discount) + tax
                                        $total = $baseRentAfterDiscount + $allsingle;

                                        // For display: show total after discount
                                        ?>
                                        <td><?php echo $total; ?></td>
                                        <td>
                                            <?php foreach($taxsetting as $tax){ ?>
                                            <?php echo "($tax->taxname".html_escape($tax->rate)."% )"; echo ($tax->rate * $baseRent) / 100; ?><br>
                                            <?php } ?>
                                        </td>
                                        <td>
                                    ...
                                    <?php
                                             // Accumulate base rent (before discount)
                                             $alltotal += $baseRent;
                                             $alltax += $allsingle;
                                             // Accumulate total after discount (base rent - discount + tax)
                                            ...
                                            // Accumulate subtotal after discount for display (base rent - discount + tax)
            ...
            <div class="card-body">
                <table class="table table-sm table-borderless mb-0">
                    <tbody>
                        ...
                        $scharge = ($allroomrent*$setting->servicecharge)/100;
                        // Total = (base rent - discount) + tax + service charge
                        $allroomrentandtaxFinal = $allroomrentAfterDiscount + $alltax + $scharge;
                        // For display: base rent + tax + service charge (before discount)
                        $allroomrentWithTaxAndService = $allroomrent + $alltax + $scharge;
                        ?>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><strong><?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        id="totalroomrentamount"><?php echo number_format($allroomrentAfterDiscount, 2); ?></span><?php if($currency->position==2){ echo html_escape($currency->curr_icon); } ?></strong>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td><strong>
                                    <?php if($currency->position==1){ echo html_escape($currency->curr_icon); } ?><span
                                        ...
                                        // CRITICAL FIX: Use final total with discount applied to base rent only
                        ...
                        <table class="invp-17">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    // Step 5: Total = (base rent - discount) + tax
                                    $intotal = $inbaseRentAfterDiscount + $singlevat;
                                    ?>
                                    <td class="invp-20">
                                    ...
                                    <?php foreach($taxsetting as $tax){ ?>
                                    <td class="invp-20">
                                        <?php echo number_format(($tax->rate * $inbaseRent) / 100, 2); ?>
                                    </td>
                                    <?php } ?>
                                    <td class="invp-21">
                                        <?php echo number_format($intotal, 2); ?></td>
                                </tr>
                            </tbody>
                        </table>
                    </td>
