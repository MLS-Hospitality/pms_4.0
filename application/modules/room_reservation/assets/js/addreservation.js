...
function newBooking() {
    ...
    var nationality = $("#allnationality").val();
    //payment details
    ...
    // Add right before $.ajax in newBooking()
if (!nationality) {
    nationality = $("#allcountry").val() || "Nigeria";   // fallback
    console.log("Using fallback nationality:", nationality);
}
